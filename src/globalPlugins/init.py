...
class GlobalPlugin(globalPluginHandler.GlobalPlugin):
    ...
    def script_toggleStuff(self, gesture):
        global pausePainting
        curSpeechMode = speech.speechMode

        if curSpeechMode == speech.speechMode_talk :
            speech.speechMode = speech.speechMode_off   # turn speechMode off
            pausePainting = True                        # turn focusHighlight off
            speech.getSynth()._set_rate(50)             # set speechrate back to 50%
            ...
            speech.speechMode = speech.speechMode_talk  # turn speechMode on
            pausePainting = False                       # turn focusHighlight on
            speech.getSynth()._set_rate(50)             # set speechrate back to 50%
    ...
    __gestures = {
        "kb:NVDA+S": "toggleStuff",
        "kb:ALT+S": "toggleStuff",
        "kb:ALT+0": "sayStuff",
        "kb:ALT+1": "sayStuff",
        "kb:ALT+2": "sayStuff",
        "kb:ALT+3": "sayStuff",
